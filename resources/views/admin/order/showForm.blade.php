                    ...
                    <div class="card card-primary card-outline">
                        <div class="card-body box-profile">
                            ...
                            <ul class="list-group list-group-unbordered mb-3">
                                ...
                                <li class="list-group-item">
                                    <b>Total Harga</b> <a class="float-right">Rp. {{ number_format($totalPrice, 0)
                                        }}</a>
                                </li>
                    ...
                    <div class="card card-primary card-outline">
                        <div class="card-body box-profile">
                            ...
                            <ul class="list-group list-group-unbordered mb-3">
                                ...
                                <img src="{{ '/storage/' . $order->evidencepayment[0]->url }}" width="30%" alt="">
                                @else
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td style="width:100px"><img
                                                src="{{ $o->product->productpictures->isNotEmpty() ? '/storage/' . $o->product->productpictures[0]->url : asset('asset/logoFic.jpg') }}"
                                                width="100%" alt=""></td>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="div d-flex justify-content-center">
                    @if (!$order->evidencepayment->isEmpty())
                    <img src="{{ '/storage/' . $order->evidencepayment[0]->url }}" width="60%" alt="">
                    @else
