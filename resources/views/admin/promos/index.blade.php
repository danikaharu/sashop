                ...
                <div class="row">
                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <a href="{{ route('promo.create') }}" class="btn btn-primary mb-3">Tambah Data</a>
                                    ...
                                    <tbody>
                                        @foreach ($promos as $promo)
                                            <tr>
                                                ...
                                                <td>{{ (new \Carbon\Carbon($promo->startdate))->format('d F Y') }}</td>
                                                <td>{{ (new \Carbon\Carbon($promo->enddate))->format('d F Y') }}</td>
                                                <td>
